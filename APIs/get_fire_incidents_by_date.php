...
// Query to fetch fire incidents within the specified date range
$query = "SELECT fire_id, tehsil_name, f_subdiv_range, f_beat_name, incharg_name, forest_guard_name, 
            ...
            FROM fire_incidents
            WHERE fire_date_time BETWEEN $1 AND $2"; // Use parameterized queries to prevent SQL injection

$result = pg_query_params($dbconn, $query, [$start_date, $end_date]);
